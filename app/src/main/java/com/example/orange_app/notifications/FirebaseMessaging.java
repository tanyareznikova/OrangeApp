...
import com.example.orange_app.ChatActivity;
...
public class FirebaseMessaging extends FirebaseMessagingService {
    ...
    private void sendNormalNotification(RemoteMessage remoteMessage) {
        ...
        PendingIntent pIntent = PendingIntent.getActivities(this, i, new Intent[]{intent}, PendingIntent.FLAG_ONE_SHOT);
